...
export const mockProgrammes: Programme[] = [
  {
    ...
    status: "open",
    description:
      "SwimSafer is Singapore's national water safety programme. Level 1 covers basic water safety, floating, and elementary swimming strokes.",
    requirements:
      "Non-swimmer or beginner. Participants must be able to enter the water independently.",
  ...
  },
  {
    ...
    status: "full",
    description:
      "Learn the basics of badminton including grip, footwork, and fundamental strokes. Suitable for beginners with no prior experience.",
  ...
  },
  {
    ...
    status: "open",
    description:
      "A comprehensive fitness assessment including body composition, cardiovascular fitness, flexibility, and muscular endurance. Receive a personalised health report.",
